		...
		return (
			<React.Fragment>
				...
				<MDBContainer className="member-details-container">
					<h1 className="h1-responsive" style={{ textAlign: 'center', marginTop: '30px' }}>Enter Your
						Details</h1>
					<MDBRow>
						<MDBCol></MDBCol>
						<MDBCol sm='12' md='8'>
							...
							{this.state.fullnameExist ?
								<MDBInput label='Fullname' value={fullname} size='md' id='fullname'
													style={{ marginBottom, width: '100%' }} disabled/>
								: <MDBInput label='Fullname' value={fullname} name='fullname'
														onChange={this.onFieldChange} size='md' id='fullname'
														style={{ marginBottom, width: '100%' }}/>
							}
							{err}

							<MDBInput label='Title' value={title} name='title' onChange={this.onFieldChange} size='md'
												id='title' style={{ marginBottom, width: '100%' }}/>

							<MDBInput label='Communication skills' value={communication_skills}
												name='communication_skills' onChange={this.onFieldChange} size='md'
												id='communication_skills' style={{ marginBottom, width: '100%' }}/>

							<MDBInput label='Language' value={language} name='language' onChange={this.onFieldChange}
												size='md' id='language' style={{ marginBottom, width: '100%' }}/>

							<MDBInput label='Tech skills' value={tech_skills} name='tech_skills'
												onChange={this.onFieldChange} size='md' id='tech_skills'
												style={{ marginBottom, width: '100%' }}/>

							<MDBInput label='Personal skills' value={personal_skills} name='personal_skills'
												onChange={this.onFieldChange} size='md' id='personal_skills'
												style={{ marginBottom, width: '100%' }}/>

							<MDBInput label='Other skills' value={other_skills} name='other_skills'
												onChange={this.onFieldChange} size='md' id='other_skills'
												style={{ marginBottom, width: '100%' }}/>

							<MDBInput label='Price' value={price} name='price' onChange={this.onFieldChange} size='md'
												id='price' style={{ marginBottom, width: '100%' }}/>

							<MDBInput label='Position in CC' value={position_in_cc} name='position_in_cc'
												onChange={this.onFieldChange} size='md' id='position_in_cc'
												style={{ marginBottom, width: '100%' }}/>

							<MDBInput label='Previous projects' value={previous_projects} name='previous_projects'
												onChange={this.onFieldChange} size='md' id='previous_projects'
												style={{ marginBottom, width: '100%' }}/>

							<MDBInput label='Education' value={education} name='education' onChange={this.onFieldChange}
												size='md' id='education' style={{ marginBottom, width: '100%' }}/>

							<MDBInput label='Location' value={location} name='location' onChange={this.onFieldChange}
												size='md' id='location' style={{ marginBottom, width: '100%' }}/>

							<MDBInput label='Note' value={note} name='note' onChange={this.onFieldChange} size='md'
												id='note' style={{ marginBottom, width: '100%' }}/>

							<div className="input-group">
								<div className="custom-file">
									<input type="file" onChange={this.fileSelectedHandler} className="custom-file-input"
												 id='filechooser'/>
									<label
										className="custom-file-label">{this.state.selectedImage ? this.state.selectedImage.name : "Choose your image!"}</label>
								</div>
							</div>

							{message}
							<MDBBtn color="primary" style={{ width: '100%', marginLeft: '-1px' }} onClick={( e ) =>{
								this.onSubmit();
