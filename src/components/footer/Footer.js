		...
		return (
			<MDBFooter className="footer font-small pt-4 mt-4">
					...
					<MDBRow>
						...
						<MDBCol md="3" smd="3">
							<p className="footer-text text-center">
								Our core development team is located all across europe which let us attract talent from
								a wider pool.
							</p>
						</MDBCol>
						...
						<MDBCol md="3" smd="3">
							<p className="footer-text text-center">
								Through our international network of freelancers, we can call in short-term assistance
								when needed.</p>
						</MDBCol>
				...
				<div className="footer-copyright text-center py-3">
					<MDBContainer fluid>
						&copy; {new Date().getFullYear()} Copyright: <a href="http://coderconsulting.de/"> Coder
						Consulting </a>
					</MDBContainer>
				</div>
			</MDBFooter>
