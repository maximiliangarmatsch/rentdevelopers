		...
		if( !localStorage.getItem('username') ){
			clientHeader = <MDBNavbarNav right>
				<MDBNavItem>
					...
					>{this.props.text4}</MDBNavLink>
				</MDBNavItem>
				<MDBNavItem>
					<MDBNavLink
						className="head-link-base head-link-5"
						to={this.props.route5}
					>{this.props.text5}</MDBNavLink>
				</MDBNavItem>
			</MDBNavbarNav>
		}else{
			clientHeader = <MDBNavbarNav right>
				<MDBNavItem>
					<MDBNavLink className="head-link-base head-link-3" to="#"
											onClick={this.onLogout}>{this.props.text2}</MDBNavLink>
				</MDBNavItem>
				<MDBNavItem>
					<MDBNavLink className="head-link-base head-link-4" to="#"
											onClick={this.onUserDetails}>{this.props.text3}</MDBNavLink>
				</MDBNavItem>
				<MDBNavItem>
					<MDBNavLink className="head-link-base head-link-5"
											to={this.props.route1}>{this.props.text1}</MDBNavLink>
				</MDBNavItem>
			</MDBNavbarNav>
		}
