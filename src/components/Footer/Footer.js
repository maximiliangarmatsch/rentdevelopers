            ...
            <MDBFooter className="footer font-small pt-4 mt-4">
                    ...
                    <MDBRow>
                        ...
                        <MDBCol md="3" smd="3">
                            <p className="footer-text text-center">
                                ...
                                freelancers, we can call in short-term
                        ...
                        <MDBCol md="3" smd="3">
                            <div className="flex-row text-center">
                                ...
                                <MDBBtn
                                    size="10"
                                    social="li"
                                    href="https://www.linkedin.com/company/coder-consulting/"
                                >
                                ...
                                <MDBBtn
                                    size="10"
                                    social="comm"
                                    href="http://coderconsulting.de/contact/"
                                >
                ...
                <div className="footer-copyright text-center py-3">
                    <MDBContainer fluid>
                        ...
                        <a href="http://coderconsulting.de/">
                            {' '}
                            Coder Consulting{' '}
                        </a>
                    </MDBContainer>
